...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,savePath: ['uesr-center']    //图片保存在服务器端的目录， 默认为空， 此时在上传图片时会向服务器请求保存图片的目录列表，
